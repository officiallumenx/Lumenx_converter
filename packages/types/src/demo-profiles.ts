...
export const SCHOOL_ACADEMIC: DemoAcademicConfig = {
  ...
  levels: [
    { id: "9", label: "Class 9", shortLabel: "9" },
    { id: "10", label: "Class 10", shortLabel: "10" },
    { id: "11", label: "Class 11", shortLabel: "11" },
    { id: "12", label: "Class 12", shortLabel: "12" },
  ],
  sections: ["A", "B", "C", "D"],
  departments: [],
  courses: [],
