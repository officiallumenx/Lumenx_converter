...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LumenX Careers — Jobs, Hiring & Recruitment" },
      {
        name: "description",
        content:
          "Discover jobs, apply with your profile, or manage institute hiring — LumenX Careers.",
      },
      { property: "og:title", content: "LumenX Careers" },
      {
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <LumenXNativeShell />
      <OfflineSyncHost app="careers" className="min-h-screen-dvh">
        <TypographyProvider>
          <Outlet />
        </TypographyProvider>
      </OfflineSyncHost>
