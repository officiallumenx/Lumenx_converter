...
const RAW_JOBS: RawJob[] = [
  {
    ...
    location: "Knowledge Park Campus, Bengaluru",
  ...
  },
  {
    ...
    postedAt: "2026-05-01",
    deadline: "2026-08-15",
    overview: "Build and maintain school digital platforms — Connect portal integrations, admin tools, and campus apps.",
    ...
    benefits: ["Health insurance", "Learning budget", "Hybrid option"],
    location: "Knowledge Park Campus, Bengaluru",
  ...
  },
  {
    ...
    city: "Bengaluru",
    state: "Karnataka",
    title: "Admissions Marketing Specialist",
    department: "Admissions",
    ...
    postedAt: "2026-05-05",
    deadline: "2026-08-01",
    overview: "Drive school admissions outreach and brand campaigns across digital channels.",
  ...
  },
  {
    ...
    postedAt: "2026-05-08",
    deadline: "2026-09-01",
    overview: "Support fee collections, budgeting, and financial reporting for the institute.",
