        ...
        <div className="rounded-2xl border border-primary/25 bg-primary/[0.04] p-4 sm:p-5">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <Button size="sm" asChild>
              <Link to="/institute/openings">Publish opening</Link>
            </Button>
            <Button size="sm" variant="outline" asChild>
              <Link to="/institute/form">Application form</Link>
            </Button>
            <Button size="sm" variant="outline" asChild>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        <div className="rounded-2xl border border-border bg-card p-4">
          ...
          <Button variant="outline" size="sm" className="mt-4" asChild>
            <Link to="/institute/profile">Edit profile</Link>
          </Button>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-card p-4">
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            ...
            <Button variant="outline" size="sm" asChild>
              <Link to="/institute/openings">Openings</Link>
            </Button>
          </div>
        </div>
        ...
        <div className="rounded-2xl border border-border bg-card p-4">
          ...
          <Button variant="outline" size="sm" className="mt-4" asChild>
            <Link to="/institute/applications">Open applications</Link>
          </Button>
        </div>
      </div>
        ...
        {recent.length === 0 ? (
          ...
          <div className="space-y-2">
            {recent.map((a) => (
              <Link
                key={a.id}
                to="/institute/applications/$applicationId"
    ...
    return (
      <div className="py-12 text-center">
        ...
        <Button className="mt-4" asChild>
          <Link to="/institute/applications">Back to list</Link>
        </Button>
      </div>
    );
  }
          ...
          {isLumenxInstitute ? (
            <>
              <Button variant="outline" asChild>
                <Link to="/institutes/$instituteId" params={{ instituteId }}>
                  Preview public page
                </Link>
              </Button>
