...
export const connectCalendarClassNames: NonNullable<DayPickerProps["classNames"]> = {
  ...
  month_caption:
    "flex h-(--cell-size) w-full items-center justify-center px-1 font-display font-semibold text-foreground",
  dropdowns: "flex w-full items-center justify-center gap-1.5 px-1",
  dropdown_root:
    "relative min-h-9 min-w-[4.25rem] rounded-md border border-border bg-background touch-manipulation",
