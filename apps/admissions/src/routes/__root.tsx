...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "LumenX Admissions — Jobs, Hiring & Recruitment" },
      {
        name: "description",
        content:
          "Discover jobs, apply with your profile, or manage institute hiring — LumenX Admissions.",
      },
      { property: "og:title", content: "LumenX Admissions" },
      {
        property: "og:description",
        content: "Job board and recruitment workspace for institutes and applicants.",
      },
...
function RootComponent() {
  ...
  return (
    <QueryClientProvider client={queryClient}>
      <LumenXNativeShell />
      <OfflineSyncHost app="admissions" className="min-h-screen-dvh">
        <TypographyProvider>
          <Outlet />
        </TypographyProvider>
      </OfflineSyncHost>
