...
import { Card, CardHeader, Button } from "@lumenx/ui-admin";
        ...
        <Card className="col-span-12 lg:col-span-6">
          ...
          <div className="px-5 pb-5">
            <Row label="Institute name" hint="Displayed across all admin tools">
              <input defaultValue="LUMENX ADMIN International School" className="h-9 w-64 px-3 rounded-md bg-background border border-border text-xs focus:outline-none focus:border-primary/40" />
            </Row>
