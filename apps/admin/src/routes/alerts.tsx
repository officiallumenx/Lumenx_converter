...
const INITIAL: Rule[] = [
  ...
  },
  {
    ...
    icon: Siren,
    desc: "Manual institute-wide critical alert (lockdown, weather, etc.).",
    priority: "P0",
  ...
  return (
    ...
    >
      ...
      >
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <Field label="Audience">
            <Select defaultValue="Class teachers">
          ...
          <div className="sm:col-span-2">
            <Field label="Trigger condition">
              <TextArea placeholder="e.g. attendance_monthly < 75" />
            </Field>
          </div>
        </div>
      </Modal>
      ...
      <Modal
        ...
        subtitle="Sends critical alert to all channels immediately"
        size="md"
        footer={
          <>
            <Button onClick={() => setEmergencyOpen(false)}>Cancel</Button>
            <Button variant="danger" onClick={sendEmergency} disabled={!emergencyMsg.trim()}>
