import type { DashboardSummary } from "./load";
...
export function resolveDashboardSummaryView(input: {
  ...
  storedSummary: DashboardSummary | null;
  storedStatus: DashboardLoadStatus;
...
export function shouldCommitDashboardLoad(opts: {
  cancelled: boolean;
