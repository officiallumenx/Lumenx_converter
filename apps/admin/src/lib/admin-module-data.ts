...
export const ADMIN_EXAMS = [
  { id: "EX-UT1", name: "Unit Test 1", term: "2025–26" },
  { id: "EX-UT2", name: "Unit Test 2", term: "2025–26" },
  { id: "EX-MID", name: "Mid-term Examination", term: "2025–26" },
  { id: "EX-FIN", name: "Term 1 Final", term: "2025–26", published: true },
] as const;
...
export const ADMISSION_APPLICATIONS = [
  ...
  },
  {
    ...
    name: "Ananya Iyer",
    grade: "Grade 11",
    stage: "parent_confirmation" as const,
    applied: "25 May 2026",
    docs: "4/4",
  },
  {
...
export const CALENDAR_HOLIDAYS = [
  ...
  { date: "2026-09-05", title: "Teachers' Day", type: "holiday" as const },
  { date: "2026-10-02", title: "Gandhi Jayanti", type: "holiday" as const },
  { date: "2026-11-14", title: "Children's Day", type: "holiday" as const },
