...
import type { CertificatesListStatus } from "./load";

export type CertificatesInstituteGateStatus =
  | "demo"
  | "loading"
  | "ready"
  | "needs_selection"
...
export type ResolveIssuedCertificatesListViewInput = {
  apiMode: boolean;
  instituteStatus: CertificatesInstituteGateStatus;
  activeInstituteId: string | null;
  resolvedForInstituteId: string | null;
  storedItems: IssuedCertificateHistoryItem[];
  storedStatus: CertificatesListStatus;
  storedErrorMessage: string | null;
  instituteErrorMessage: string | null;
};

export type IssuedCertificatesListView = {
...
export function resolveIssuedCertificatesListView(
  input: ResolveIssuedCertificatesListViewInput,
...
export function shouldCommitIssuedCertificatesLoad(opts: {
  cancelled: boolean;
