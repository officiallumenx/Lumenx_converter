...
const rowA: NotificationInboxListItem = {
  id: "inbox-a",
  title: "Alert A",
  desc: "Body A",
  detail: "Body A",
...
describe("resolveNotificationInboxListView", () => {
  it("demo mode passes through stored demo rows", () => {
    const view = resolveNotificationInboxListView({
      apiMode: false,
...
describe("shouldCommitNotificationInboxLoad", () => {
