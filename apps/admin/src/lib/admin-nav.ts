import {
  ...
  HardDrive, Settings, Building2, Heart, CalendarDays, Siren, KeyRound,
  Megaphone, Layers, ClipboardList, Bus, Plane, Receipt, UserCheck,
  Briefcase, Landmark, Calendar, FileBarChart, Award, BookOpen, UserCog,
  type LucideIcon,
} from "lucide-react";
...
export const adminNav: readonly AdminNavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/teacher-attendance", label: "Teacher Attendance", icon: UserCog },
  ...
  },
  {
    ...
    items: [
      ...
      { to: "/leave", label: "Leave Center", icon: Plane },
