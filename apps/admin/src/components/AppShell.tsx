...
/** Page chrome stays brand blue/white; module hues stay on nav icons only. */
const PAGE_CHROME_ACCENT = {
...
export function AppShell({
  ...
  return (
    <div className="max-w-[1600px] mx-auto w-full" style={PAGE_CHROME_ACCENT}>
