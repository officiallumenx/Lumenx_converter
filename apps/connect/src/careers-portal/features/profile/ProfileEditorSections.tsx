        ...
        <div className="flex-1 space-y-3 w-full">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              placeholder="e.g. Senior Math Teacher · 8+ years · Hyderabad"
            />
          </div>
          <div className="space-y-2">
...
export function ProfileContactAddressSection({
  ...
  return (
    <ProfileSectionCard
      ...
      description="Contact details and location for applications and job matching."
    >
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div className="space-y-2">
          <Label className="flex items-center gap-2">
            <Phone className="size-4 text-muted-foreground" /> Mobile
          </Label>
          <Input value={phone ?? ""} readOnly className="bg-muted/50" />
        </div>
      </div>
      <p className="text-xs text-muted-foreground">
        Email and mobile are managed from your account settings after signup verification.
      </p>
        ...
        <div key={exp.id} className="rounded-xl border border-border p-4 space-y-3">
          ...
          <label className="flex items-center gap-2 text-sm">
            <input
              ...
              checked={!!exp.current}
              onChange={(e) =>
                update(i, { current: e.target.checked, to: e.target.checked ? undefined : exp.to })
              }
            />
      ...
      {internships.map((item, i) => (
        <div key={item.id} className="rounded-xl border border-border p-4 space-y-3">
          ...
          <div className="grid gap-3 sm:grid-cols-2">
            ...
            <div className="space-y-2">
              <Label>Start</Label>
              <Input value={item.from} onChange={(e) => update(i, { from: e.target.value })} />
            </div>
            <div className="space-y-2">
              <Label>End</Label>
              <Input
          ...
          <label className="flex items-center gap-2 text-sm">
            <input
              ...
              onChange={(e) =>
                update(i, { current: e.target.checked, to: e.target.checked ? undefined : item.to })
              }
            />
...
export function ProfileWorkSection({
  ...
  return (
    <ProfileSectionCard
      ...
      description="Full-time roles and internship history in one place."
    >
      <ProfileSubsection
          ...
          <Button
            ...
            onClick={() =>
              onChange({
                internships: [
                  ...internships,
                  { id: createProfileId("int"), title: "", company: "", from: "", current: false },
                ],
              })
            }
          >
      ...
      >
        <InternshipList
          ...
          onChange={(next) => onChange({ internships: next })}
        />
      </ProfileSubsection>
    </ProfileSectionCard>
  );
          ...
          {qualifications.map((q, i) => (
            <div key={q.id} className="rounded-xl border border-border p-4 space-y-3">
              <div className="flex justify-between gap-2">
                ...
                <EntryActions
                  onRemove={() => onChange(qualifications.filter((x) => x.id !== q.id))}
                />
              </div>
              <div className="grid gap-3 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(v) =>
                      update(i, { educationLevel: v as QualificationEntry["educationLevel"] })
                    }
                  >
                    <SelectTrigger>
                      <SelectValue />
                ...
                <div className="space-y-2">
                  ...
                  <Input value={q.degree} onChange={(e) => update(i, { degree: e.target.value })} />
                </div>
                <div className="space-y-2">
                  <Label>Field of study</Label>
                  <Input value={q.field} onChange={(e) => update(i, { field: e.target.value })} />
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  <Label>Year</Label>
                  <Input value={q.year} onChange={(e) => update(i, { year: e.target.value })} />
                </div>
                <div className="space-y-2">
              ...
              <label className="flex items-center gap-2 text-sm">
                <input
                  type="checkbox"
                  checked={!!q.pursuing}
                  onChange={(e) => update(i, { pursuing: e.target.checked })}
                />
                Currently pursuing
              </label>
            </div>
...
export function ProfileCertificationsAchievementsSection({
  ...
  return (
    <ProfileSectionCard
      ...
      description="Licenses, credentials, awards, and notable accomplishments."
    >
      <ProfileSubsection
          ...
          <Button
            ...
            onClick={() =>
              onChange({
                certifications: [
                  ...certifications,
                  { id: createProfileId("cert"), name: "", issuer: "", year: "" },
                ],
              })
            }
          >
            ...
            {certifications.map((c, i) => (
              <div key={c.id} className="rounded-xl border border-border p-4 space-y-3">
                <div className="flex justify-between gap-2">
                  ...
                  <EntryActions
                    onRemove={() =>
                      onChange({ certifications: certifications.filter((x) => x.id !== c.id) })
                    }
                  />
                </div>
                <div className="grid gap-3 sm:grid-cols-2">
          ...
          <Button
            ...
            onClick={() =>
              onChange({
                achievements: [
                  ...achievements,
                  { id: createProfileId("ach"), title: "", year: "" },
                ],
              })
            }
          >
            ...
            {achievements.map((a, i) => (
              <div key={a.id} className="rounded-xl border border-border p-4 space-y-3">
                <div className="flex justify-between gap-2">
                  ...
                  <EntryActions
                    onRemove={() =>
                      onChange({ achievements: achievements.filter((x) => x.id !== a.id) })
                    }
                  />
                </div>
                <div className="grid gap-3 sm:grid-cols-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input
                      value={a.year ?? ""}
                      onChange={(e) => updateAch(i, { year: e.target.value })}
                    />
                  </div>
                  <div className="space-y-2 sm:col-span-2">
...
export function ProfileSkillsLanguagesSection({
  ...
  return (
    <ProfileSectionCard
      ...
      description="Technical skills, soft skills, and language proficiency."
    >
      <TagInput
        label="Technical skills"
        value={skills}
        onChange={(next) => onChange({ skills: next })}
        placeholder="e.g. Python, Tally, Curriculum design"
      />
      <TagInput
        label="Soft skills"
        value={softSkills}
        onChange={(next) => onChange({ softSkills: next })}
            ...
            <Button
              ...
              onClick={() =>
                onChange({
                  languageSkills: [
                    ...languageSkills,
                    { id: createProfileId("lang"), language: "", proficiency: "conversational" },
                  ],
                })
              }
            >
                ...
                <div key={lang.id} className="flex flex-wrap items-end gap-2">
                  ...
                  <div className="flex-1 min-w-[160px] space-y-2">
                    ...
                    <Select
                      ...
                      onValueChange={(v) =>
                        updateLang(i, { proficiency: v as LanguageEntry["proficiency"] })
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
                  ...
                  <EntryActions
                    onRemove={() =>
                      onChange({ languageSkills: languageSkills.filter((x) => x.id !== lang.id) })
                    }
                  />
                </div>
              ))}
...
export function ProfileResumeLinksSection({
  ...
  return (
    <ProfileSectionCard
      title="Resume & links"
      description="Upload your resume and add portfolio or social profile links."
    >
      <DocumentUploadCard
              ...
              onClick={() =>
                onChange({
                  profileLinks: [
                    ...
                    { id: createProfileId("link"), label: "", url: "" },
                  ],
                })
              }
            >
              ...
              {profile.profileLinks.map((link, i) => (
                <div key={link.id} className="flex flex-wrap items-end gap-2">
                  ...
                  <EntryActions
                    onRemove={() =>
                      onChange({
                        profileLinks: profile.profileLinks.filter((x) => x.id !== link.id),
                      })
                    }
                  />
                </div>
      ...
      <p className="text-xs text-muted-foreground">
        ...
        <Link to="/careers/documents" className="text-primary hover:underline">
          document center
        </Link>
        .
      </p>
