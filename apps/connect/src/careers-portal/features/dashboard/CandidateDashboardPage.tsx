    ...
    <div className="animate-in fade-in duration-300 space-y-8">
      ...
      <SectionCard title="Quick actions">
        <div className="grid gap-2 sm:grid-cols-2 lg:grid-cols-4">
          {[
            { label: "Browse jobs", to: "/careers/jobs", icon: Briefcase },
            { label: "Update profile", to: "/careers/profile", icon: User },
            { label: "Upload documents", to: "/careers/documents", icon: Upload },
      ...
      {recommended.length > 0 && (
        <SectionCard title="Recommended for you" link="/careers/jobs" linkLabel="View all">
