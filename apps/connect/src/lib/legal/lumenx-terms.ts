...
export const CAREERS_TERMS: LegalDocument = {
  title: "Terms & Conditions — LumenX Careers",
  lastUpdated: "June 20, 2026",
  intro:
    "These Terms govern your use of the LumenX Careers portal, including job seeker accounts, recruiter workspaces, job listings, applications, and related features.",
  sections: [
    {
