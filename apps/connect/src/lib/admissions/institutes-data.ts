...
export const ADMISSION_INSTITUTES: AdmissionInstituteProfile[] = [
  {
    ...
    contact: { phone: "+91 40 4455 8800", email: "admissions@lumenx.edu", address: "Green Park Campus, Hyderabad 500032" },
    admissionDates: [
      { label: "Applications open", date: "1 Mar 2026" },
      { label: "Deadline", date: "31 May 2026" },
    ],
    about: "LumenX Academy is a premier K-12 institution offering holistic education with integrated digital learning through LumenX Connect.",
    established: "1998",
  ...
  },
  {
    ...
    contact: { phone: "+91 11 4400 2200", email: "admissions@dpsriverside.edu", address: "Riverside Enclave, New Delhi 110021" },
    admissionDates: [
      { label: "Early bird", date: "15 Apr 2026" },
      { label: "Regular", date: "30 Jun 2026" },
    ],
    about: "DPS Riverside combines rigorous academics with creative expression and global exposure programs.",
    established: "2005",
    accreditation: "CBSE",
  },
  {
    ...
    contact: { phone: "+91 22 2200 3300", email: "admissions@stxaviersjc.edu", address: "Fort, Mumbai 400001" },
    admissionDates: [{ label: "Merit list", date: "10 Jun 2026" }],
    about: "St. Xavier's JC prepares students for competitive exams with strong faculty and structured mentoring.",
    established: "1963",
  ...
  },
  {
    ...
    contact: { phone: "+91 20 6600 4400", email: "admissions@fergusson.edu", address: "FC Road, Pune 411004" },
    admissionDates: [{ label: "UG admissions", date: "1 Jul 2026" }],
    about: "Fergusson College offers undergraduate programs with a balance of tradition and modern pedagogy.",
    established: "1885",
  ...
  },
  {
    ...
    contact: { phone: "+91 712 2800 5500", email: "admissions@vnit.ac.in", address: "South Ambazari Road, Nagpur 440010" },
    admissionDates: [{ label: "JEE counselling", date: "Jul 2026" }],
    about: "Visvesvaraya National Institute of Technology is a premier engineering institute with national recognition.",
    established: "1960",
  ...
  },
  {
    ...
    contact: { phone: "+91 542 6700 6600", email: "admissions@bhu.ac.in", address: "Varanasi 221005" },
    admissionDates: [{ label: "CUET admissions", date: "Aug 2026" }],
    about: "BHU is one of India's largest residential universities offering diverse undergraduate and postgraduate programs.",
    established: "1916",
