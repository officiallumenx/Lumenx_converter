...
>(({ className, interactive = false, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "transition-[box-shadow,border-color,background-color] duration-200 ease-[var(--ease-standard)]",
      interactive &&
        "motion-safe:hover:border-primary/20 motion-safe:hover:shadow-elevated focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring",
      className,
    )}
    {...props}
  />
