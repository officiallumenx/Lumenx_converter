...
function ResourcesDemoPage() {
  ...
  const navigate = useNavigate({ from: "/resources/demo" });
  ...
  return (
    <SiteShell>
      ...
      >
        <ConversionNav active="/resources/demo" />
      ...
      <GetStartedCTA
        ...
        body="Book a demo or get started when you’re ready. A 60-day trial begins after the institute is approved."
        primary={
